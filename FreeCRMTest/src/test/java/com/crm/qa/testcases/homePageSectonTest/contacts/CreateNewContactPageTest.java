...
//	}
	...
	public void saveContactTest(String userFname, String userLname) {
		...
		contactDetailsPage.waitUntilPageIsLoaded();
		Assert.assertTrue(contactDetailsPage.userName(userFname+" "+userLname));
	}
